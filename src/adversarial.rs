...
pub fn run_adversarial_tests() -> bool {
    ...
    total_attempts += 1;
    let read_only_cap = Capability::new(201, READ);
    ...
    total_attempts += 1;
    let rw_cap = Capability::new(202, READ | WRITE);
    ...
    total_attempts += 1;
    let parent_cap = Capability::new(203, ALL_PERMS);
    ...
    total_attempts += 1;
    let limited_cap = Capability::new(204, READ | WRITE);
